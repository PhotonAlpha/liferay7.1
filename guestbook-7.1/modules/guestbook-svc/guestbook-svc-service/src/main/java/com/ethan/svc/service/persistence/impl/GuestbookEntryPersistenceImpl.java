...
import com.ethan.svc.exception.NoSuchGuestbookEntryException;
import com.ethan.svc.model.GuestbookEntry;
import com.ethan.svc.model.impl.GuestbookEntryImpl;
import com.ethan.svc.model.impl.GuestbookEntryModelImpl;
...
public class GuestbookEntryPersistenceImpl
	...
	public GuestbookEntry updateImpl(GuestbookEntry guestbookEntry) {
		...
		if (!GuestbookEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
	...
	public Map<Serializable, GuestbookEntry> fetchByPrimaryKeys(
		...
		Map<Serializable, GuestbookEntry> map =
			new HashMap<Serializable, GuestbookEntry>();
		...
		sb.append(_SQL_SELECT_GUESTBOOKENTRY_WHERE_PKS_IN);
		...
		try {
			...
			for (GuestbookEntry guestbookEntry :
					(List<GuestbookEntry>)query.list()) {
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindAll = new FinderPath(
			GuestbookEntryModelImpl.ENTITY_CACHE_ENABLED,
			GuestbookEntryModelImpl.FINDER_CACHE_ENABLED,
			GuestbookEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		_finderPathFetchByUUID_G = new FinderPath(
			GuestbookEntryModelImpl.ENTITY_CACHE_ENABLED,
			GuestbookEntryModelImpl.FINDER_CACHE_ENABLED,
			GuestbookEntryImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
	...
	private static final String _SQL_SELECT_GUESTBOOKENTRY_WHERE_PKS_IN =
		"SELECT guestbookEntry FROM GuestbookEntry guestbookEntry WHERE entryId IN (";
