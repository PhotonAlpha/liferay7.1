...
import com.ethan.svc.model.GuestbookEntryModel;
...
public class GuestbookEntryModelImpl
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(
		com.ethan.svc.service.util.ServiceProps.get(
			"value.object.entity.cache.enabled.com.ethan.svc.model.GuestbookEntry"),
		true);

	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(
		com.ethan.svc.service.util.ServiceProps.get(
			"value.object.finder.cache.enabled.com.ethan.svc.model.GuestbookEntry"),
		true);

	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(
		com.ethan.svc.service.util.ServiceProps.get(
			"value.object.column.bitmask.enabled.com.ethan.svc.model.GuestbookEntry"),
		true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		com.ethan.svc.service.util.ServiceProps.get(
			"lock.expiration.time.com.ethan.svc.model.GuestbookEntry"));
	...
	static {
		...
		attributeGetterFunctions.put(
			"uuid",
			new Function<GuestbookEntry, Object>() {

				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getUuid();
				}

			});
		attributeSetterBiConsumers.put(
			"uuid",
			new BiConsumer<GuestbookEntry, Object>() {

				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object uuidObject) {

					guestbookEntry.setUuid((String)uuidObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object entryIdObject) {

					guestbookEntry.setEntryId((Long)entryIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object nameObject) {

					guestbookEntry.setName((String)nameObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getEmail();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object emailObject) {

					guestbookEntry.setEmail((String)emailObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getMessage();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object messageObject) {

					guestbookEntry.setMessage((String)messageObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getGuestbookId();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object guestbookIdObject) {

					guestbookEntry.setGuestbookId((Long)guestbookIdObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getGroupId();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object groupIdObject) {

					guestbookEntry.setGroupId((Long)groupIdObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getCompanyId();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object companyIdObject) {

					guestbookEntry.setCompanyId((Long)companyIdObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getUserId();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object userIdObject) {

					guestbookEntry.setUserId((Long)userIdObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getUserName();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object userNameObject) {

					guestbookEntry.setUserName((String)userNameObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getCreateDate();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object createDateObject) {

					guestbookEntry.setCreateDate((Date)createDateObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getModifiedDate();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object modifiedDateObject) {

					guestbookEntry.setModifiedDate((Date)modifiedDateObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getStatus();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object statusObject) {

					guestbookEntry.setStatus((Integer)statusObject);
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getStatusByUserId();
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getStatusByUserName();
				}
		...
		attributeGetterFunctions.put(
			...
			new Function<GuestbookEntry, Object>() {
				...
				@Override
				public Object apply(GuestbookEntry guestbookEntry) {
					return guestbookEntry.getStatusDate();
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<GuestbookEntry, Object>() {
				...
				@Override
				public void accept(
					GuestbookEntry guestbookEntry, Object statusDateObject) {

					guestbookEntry.setStatusDate((Date)statusDateObject);
				}
