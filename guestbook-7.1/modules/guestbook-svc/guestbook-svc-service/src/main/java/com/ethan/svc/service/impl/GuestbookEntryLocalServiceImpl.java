...
package com.ethan.svc.service.impl;

import com.ethan.svc.exception.GuestbookEntryEmailException;
import com.ethan.svc.exception.GuestbookEntryMessageException;
import com.ethan.svc.exception.GuestbookEntryNameException;
import com.ethan.svc.model.GuestbookEntry;
import com.ethan.svc.service.base.GuestbookEntryLocalServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.ethan.svc.service.GuestbookEntryLocalService</code> interface.
 *
 * <p>
...
public class GuestbookEntryLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>com.ethan.svc.service.GuestbookEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ethan.svc.service.GuestbookEntryLocalServiceUtil</code>.
	 */
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>com.ethan.service.service.GuestbookEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ethan.service.service.GuestbookEntryLocalServiceUtil</code>.
	 */
